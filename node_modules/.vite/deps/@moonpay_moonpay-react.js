  ...
  return new Promise((resolve, reject) => {
    ...
    if (existingScript) {
      ...
      script.addEventListener("load", () => {
        ...
        scriptLoadingStatus.isLoading = false;
        scriptLoadingStatus.isLoaded = true;
        resolve((_a = window.MoonPayWebSdk) == null ? void 0 : _a.init);
      });
...
var useSdk = (config, visible, onUrlSignatureRequested) => {
  ...
  const handleUpdateSignatureAndShow = (0, import_react7.useCallback)(async () => {
    ...
    if (onUrlSignatureRequested) {
      ...
      try {
        const updatedSignature = await (onUrlSignatureRequested == null ? void 0 : onUrlSignatureRequested(url));
        if (!updatedSignature) {
          return;
        }
        (_a = sdk.current) == null ? void 0 : _a.updateSignature(updatedSignature);
      } catch (e) {
    ...
    if (visible) {
      (_b = sdk.current) == null ? void 0 : _b.show();
    }
  ...
  (0, import_react7.useEffect)(() => {
    ...
    const newSdk = (init == null ? void 0 : init(config)) || null;
    sdk.current = newSdk;
...
//# sourceMappingURL=@moonpay_moonpay-react.js.map
